...
const char* evaluate_team_main(int id1, int id2, int id3, int troop, int main_idx);
const char* evaluate_team_references(int id1, int id2, int id3, int troop, int main_idx, int sims);
...
const char* set_local_account_tactic(const char* account_id, const char* tactic_name, int owned);
